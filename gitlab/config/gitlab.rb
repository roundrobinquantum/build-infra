...
### OUR LDAP CONFIGURATIONS
gitlab_rails['ldap_enabled'] = true
gitlab_rails['ldap_servers'] = YAML.load <<-'EOS'
   main:
     label: 'HB Marketplace Listing'
     host: '172.26.0.8'
     port: 389
     uid: 'sAMAccountName'
     method: 'plain'
     bind_dn: 'CN=mpl_gitlab,CN=TRUMP-DC-01,CN=Servers,CN=HEADQUARTER,CN=Sites,CN=Configuration,DC=infoshop,DC=com,DC=tr'
     password: 'GITLAB_LDAP_PASS'
     active_directory: true
     allow_username_or_email_login: false
     block_auto_created_users: false
     base: 'DC=infoshop,DC=com,DC=tr'
EOS
#     user_filter: ''
#     attributes:
